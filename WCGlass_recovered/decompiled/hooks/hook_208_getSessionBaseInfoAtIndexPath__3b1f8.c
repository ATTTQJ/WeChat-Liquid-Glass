/* Hook replacement 208/418
 * Selectors: SEL_getSessionBaseInfoAtIndexPath_
 * Address: 0x3b1f8; original size: 136 bytes
...
void sub_3b1f8(long long a0, long long a1, long long a2)
{
    ...
    if (!v13)
        ...
        v14 = v13;
    v15 = v14;
    _objc_retainAutoreleasedReturnValue(g_57c0b0(), a1, v15);
    _objc_release(v13);
    _objc_release(v12);
}
