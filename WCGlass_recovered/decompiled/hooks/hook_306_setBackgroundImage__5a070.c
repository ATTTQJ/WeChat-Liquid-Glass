/* Hook replacement 306/418
 * Selectors: SEL_setBackgroundImage_
 * Address: 0x5a070; original size: 124 bytes
...
void sub_5a070(unsigned long a0, unsigned long a1, long long a2)
{
