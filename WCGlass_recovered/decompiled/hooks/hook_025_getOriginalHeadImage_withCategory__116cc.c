/* Hook replacement 25/418
 * Selectors: SEL_getOriginalHeadImage_withCategory_
 * Address: 0x116cc; original size: 164 bytes
...
void sub_116cc(unsigned long a0, long long a1, long long a2, long long a3)
{
    ...
    if (v16)
        ...
        _objc_retainAutoreleasedReturnValue(g_57b4c8(a0, a1, a2, a3), a1, a2, a3);
    _objc_release(v16);
    _objc_release(a2);
}
