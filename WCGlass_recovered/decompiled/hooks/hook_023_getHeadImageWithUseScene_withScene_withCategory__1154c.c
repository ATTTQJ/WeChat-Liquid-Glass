/* Hook replacement 23/418
 * Selectors: SEL_getHeadImageWithUseScene_withScene_withCategory_
 * Address: 0x1154c; original size: 172 bytes
...
void sub_1154c(unsigned long a0, long long a1, long long a2, long long a3, long long a4)
{
    ...
    if (v16)
        ...
        _objc_retainAutoreleasedReturnValue(g_57b4b8(a0, a1, a2, a3, a4), a1, a2, a3, a4);
    _objc_release(v16);
    _objc_release(a2);
}
