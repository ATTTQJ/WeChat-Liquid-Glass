/* Hook replacement 150/418
 * Selectors: SEL_setImage_
 * Address: 0x1f798; original size: 324 bytes
 * Status: ok; elapsed: 0.392s
 */
...
void sub_1f798(long long a0, unsigned long a1, long long a2)
{
    unsigned long long v9;  // x24
    unsigned long long v10;  // x23
    unsigned long long v19;  // w22
    unsigned long long v20;  // w23
...
LABEL_1f84c:
        if ((g_582f88 & 1))
        {
            v19 = (unsigned int)sub_43d704(a0);
            if ((v18 & 1))
                goto LABEL_1f8a4;
LABEL_1f860:
            v20 = 0;
        ...
        else
        {
            ...
            if (!(v18 & 1))
                goto LABEL_1f860;
LABEL_1f8a4:
            v20 = (unsigned int)sub_19639c(a0);
            if (v19)
            {
LABEL_1f868:
                _objc_release(v16);
