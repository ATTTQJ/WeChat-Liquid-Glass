/* Hook replacement 378/418
 * Selectors: SEL_setAttributedTitle_forState_
 * Address: 0x693d0; original size: 104 bytes
...
void sub_693d0(long long a0, unsigned long a1, long long a2, unsigned long a3)
{
