/* Hook replacement 412/418
 * Selectors: SEL_setConfiguration_
 * Address: 0x86430; original size: 88 bytes
...
void sub_86430(long long a0, unsigned long a1, long long a2)
{
