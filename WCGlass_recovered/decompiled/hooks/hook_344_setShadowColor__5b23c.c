/* Hook replacement 344/418
 * Selectors: SEL_setShadowColor_
 * Address: 0x5b23c; original size: 220 bytes
 * Status: ok; elapsed: 0.362s
 */
...
void sub_5b23c(unsigned long a0, unsigned long a1, unsigned long long count)
{
