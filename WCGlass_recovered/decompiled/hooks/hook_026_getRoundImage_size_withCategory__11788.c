/* Hook replacement 26/418
 * Selectors: SEL_getRoundImage_size_withCategory_
 * Address: 0x11788; original size: 196 bytes
 * Status: ok; elapsed: 0.449s
 */
...
void sub_11788(unsigned long a0, long long a1, long long a2, long long a3)
{
    ...
    if (v20)
        ...
        _objc_retainAutoreleasedReturnValue(g_57b4d0(a0, a1, a2, a3), a1, a2, a3);
    _objc_release(v20);
    _objc_release(a2);
}
