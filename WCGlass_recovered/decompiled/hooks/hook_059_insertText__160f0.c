/* Hook replacement 59/418
 * Selectors: SEL_insertText_
 * Address: 0x160f0; original size: 180 bytes
 * Status: ok; elapsed: 0.404s
 */
...
void sub_160f0(long long a0, unsigned long a1, long long a2)
{
    ...
    {
        v12 = _objc_retainAutoreleasedReturnValue(sub_17f9c(a0));
        g_57b648(a0, a1, a2);
        sub_18900(a0, v12);
        _objc_release(v12);
    }
