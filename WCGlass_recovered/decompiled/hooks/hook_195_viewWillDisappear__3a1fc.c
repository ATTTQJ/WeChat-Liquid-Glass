/* Hook replacement 195/418
 * Selectors: SEL_viewWillDisappear_
 * Address: 0x3a1fc; original size: 72 bytes
 * Status: ok; elapsed: 0.216s
 */
...
void sub_3a1fc(unsigned long a0, unsigned long a1, unsigned long a2)
{
