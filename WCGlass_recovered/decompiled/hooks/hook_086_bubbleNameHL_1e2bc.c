/* Hook replacement 86/418
 * Selectors: SEL_bubbleNameHL
 * Address: 0x1e2bc; original size: 252 bytes
 * Status: ok; elapsed: 0.482s
 */
...
void sub_1e2bc(long long a0)
{
    ...
    v4 = &v6;
    v5 = v11;
    v12 = _objc_retainAutoreleasedReturnValue(g_57b868());
