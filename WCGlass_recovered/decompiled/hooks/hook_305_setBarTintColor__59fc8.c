/* Hook replacement 305/418
 * Selectors: SEL_setBarTintColor_
 * Address: 0x59fc8; original size: 148 bytes
 * Status: ok; elapsed: 0.274s
 */
...
void sub_59fc8(long long a0, unsigned long a1, long long a2)
{
