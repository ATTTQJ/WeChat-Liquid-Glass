/* Hook replacement 340/418
 * Selectors: SEL_setBackgroundColor_
 * Address: 0x5aec4; original size: 220 bytes
 * Status: ok; elapsed: 0.358s
 */
...
void sub_5aec4(unsigned long a0, unsigned long a1, unsigned long long count)
{
