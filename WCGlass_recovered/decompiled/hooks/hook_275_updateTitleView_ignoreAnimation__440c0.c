/* Hook replacement 275/418
 * Selectors: SEL_updateTitleView_ignoreAnimation_
 * Address: 0x440c0; original size: 184 bytes
 * Status: ok; elapsed: 1.02s
 */
...
void sub_440c0(long long a0, unsigned long a1, long long a2, unsigned long a3)
{
